...
<p>上周四，一个叫"同事.skill"的GitHub项目突然刷屏了。</p>
...
<blockquote><p><strong>"We know more than we can tell."</strong><br>
我们知道的，远多于我们能说出来的。</p></blockquote>
...
<blockquote><p>"这个接口要用分段锁，上次压测全局锁在QPS超过5000时P99延迟飙到800ms"</p></blockquote>

<p>替换成：</p>

<blockquote><p>"这个接口要注意性能优化，建议根据实际场景选择合适的方案"</p></blockquote>
...
<blockquote><p><strong>如果有人让你把工作的所有经验写成一个完整文档，你能写完吗？</strong></p></blockquote>
