...
---
layout: post
title: MCP是什么？AI工具正在学会"长出手"
date: 2026-04-27
permalink: /posts/ai-tools/mcp-ai-tool-connector.html
category: ai-tools
tags: [AI工具, MCP, Claude, 技术科普]
---
...
MCP 做的就是类似的事。它定义了一套标准，让任何支持 MCP 的 AI 可以**统一地**连接各种工具：文件系统、数据库、浏览器、邮件服务、代码仓库……
