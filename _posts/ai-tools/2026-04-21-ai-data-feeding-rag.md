...
---
permalink: /posts/ai-tools/others/2026-04-21-ai-data-feeding-rag.html
layout: post
title: "你投喂给AI的数据，为什么第二天就忘了？"
date: 2026-04-21
category: ai-tools/others
category_name: "AI工具/其他"
tags: [RAG, AI投喂, 向量检索, 知识库, DeepSeek]
---
...
你问AI一个问题。AI只能凭它"脑子"里（预训练数据）记得的东西回答。如果它没学过（比如你公司的内部文档），它为了面子，就会开始**编造**（术语叫"幻觉"）。
